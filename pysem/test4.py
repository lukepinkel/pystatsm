...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 27 01:35:37 2020
...
from ..utilities import numerical_derivs
from pystats.utilities.linalg_operations import vech
...
mod.fit(xtol=1e-200, gtol=1e-40, maxiter=5000, verbose=3)
